...
def cal_all_stats(S_attr_exp1,all_logits,all_logits_org,all_attr_gt,all_pair_gt,pairs,yfs,stats,test_dataset,config):
    ...
    if test_dataset.phase == "val" and val_uce_list_ep1==[]:
        ...
        uce_expert2, bin_uncertainties_expert2, bin_errors_expert2, prop_in_bin_values_expert2,bin_n_samples_ep2, bin_variances_ep2 = compute_uce(S_pair_exp2, all_pair_gt)
...
def test(
        ...
        all_obj_gt,
        all_pair_gt,
        config,all_logits_org = None):   #新增原本尚未改過的all_logit
